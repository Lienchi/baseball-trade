...
// 品牌 logo（simple-icons 的官方 path）：lucide 沒有 Threads、IG 也只有單色線框
function ThreadsIcon() {
  return (
    <svg viewBox="0 0 24 24" width={14} height={14} className="fill-scoreboard" aria-hidden>
...
function InstagramIcon() {
  return (
    <svg viewBox="0 0 24 24" width={14} height={14} fill="#E4405F" aria-hidden>
...
// 社群帳號連結列：品牌 icon + @handle，沒填任何平台時不佔空間
    ...
    <p className="mt-2 flex flex-wrap items-center gap-x-4 gap-y-1">
      {entries.map(platform => (
        <a
          ...
          className="flex items-center gap-1.5 text-xs font-medium text-scoreboard hover:underline"
        >
